...
public class ThursdayFragment extends Fragment {
    ...
    private void showTue(final String deptName, final String deptField, final String deptSpec) {
        ...
        final DatabaseReference   database1 = FirebaseDatabase.getInstance().getReference("TeacherClass").child(deptName).child(deptField).child(currentUserId).child("DailyTimeTable").child("Thursday");
